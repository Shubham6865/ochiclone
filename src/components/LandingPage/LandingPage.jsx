    ...
    return (
        <div data-scroll data-scroll-speed="-.3" className=' bg-[#F1F1F1] w-full pb-10 pt-1 ' id='home'>
            <div className='flex items-center justify-between  '>
                    ...
                    {["We Create", "Eye Opening", "Presentations"].map((item, index) => (
                        ...
                        <div className="masker " key={index}>
                            <div className="w-fit flex items-end overflow-hidden ">
                                ...
                                <h1 className="pt-[1vw] pr-1 -md-[1vw] uppercase text-[9vw] md:text-[8vw] leading-[0.90] 
                ...
                <div className="siteoftheday mt-24  ">
            ...
            <div className=" border-zinc-400 border-t-[1px] mt-4 md:mt-16 flex flex-col md:flex-row  justify-between items-start md:items-center pt-10  px-10 md:px-20    ">
                {["For public and private companies", "From the first pitch to IPO"].map((item, index) => (
                    <p className='text-md  tracking-tight leading-none mb-5 md:mb-0  ' key={index}>
                        {item}
                    </p>
                ))}

                <Startbtn title={'start the project'} />
