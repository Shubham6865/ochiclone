            ...
            <div className='mt-[60vh]  md:mt-2 w-full h-[50vh] md:h-screen  p-5  md:p-16 flex gap-5 font-["Founders_Grotesk_X-Condensed, Roboto, sans-serif"]'>
                <div className='w-full  p-5  md:p-16 flex gap-5 '>
                    ...
                    <div className="w-1/2">
                        ...
                        <div className='font-[" Neue_Montreal, Roboto, sans-serif"] mt-10'>
                            <a href="#" className='block text-xl font-light '>Facebook</a>
                            <a href="#" className='block text-xl font-light '>Instagram</a>
